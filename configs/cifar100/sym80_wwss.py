...
# TODO
noise_mode, noise_ratio = 'sym', 0.8  # ['asym', 'sym']
lam_u, lam_p = 150, 1.0
thresh_mode, p_margin, p_thresh = 'single', 0.1, 0.5  # ['cross', 'single']; if 'cross', set p_margin; TODO
# relabel
retype = 'all'  # ['all', 'unlabel']
t_relabel, re_epochs = [0.5], [101]
label_path = './datasets/labels/cifar100/all/sym80.npy'
